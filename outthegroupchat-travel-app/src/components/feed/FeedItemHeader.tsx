...
export interface FeedItemHeaderUser {
  id: string;
  name: string | null;
  image: string | null;
}

export interface FeedItemHeaderConfig {
  icon: string;
  action: string;
  color: string;
}
...
export interface FeedItemHeaderProps {
  user: FeedItemHeaderUser;
  config: FeedItemHeaderConfig;
  timeAgo: string;
  safeUserId: string;
...
export function FeedItemHeader({
  ...
  void user; // user object passed for potential future use; derived safe values used directly
