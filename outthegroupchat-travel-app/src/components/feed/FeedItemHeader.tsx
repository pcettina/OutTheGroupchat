...
import { sanitizeRouteSegment, sanitizeText, sanitizeUrl, typeConfig, type FeedItemType, type FeedUser } from './FeedItemTypes';
...
export function FeedItemHeader({ user, type, timeAgo, saved, onSave, content }: FeedItemHeaderProps) {
