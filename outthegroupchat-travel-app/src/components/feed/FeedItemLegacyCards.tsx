...
import type { TripPayload, ActivityPayload } from './FeedItemTypes';
import { categoryEmojis } from './FeedItemTypes';

// ─── Legacy: Trip Card ────────────────────────────────────────────────────────

interface LegacyTripCardProps {
  trip: TripPayload;
  safeTripId: string;
...
/**
 * Renders a legacy trip payload as a card linked to /trips/[id].
 * Supports optional cover image, date range, and status badge.
 */
...
/**
 * Renders a legacy activity payload as a card with category emoji,
 * name, optional description, and optional cost.
 */
