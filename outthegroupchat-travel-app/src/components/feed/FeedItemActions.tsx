...
import type { Reaction, Comment } from './FeedItemTypes';
...
interface FeedItemActionsProps {
  itemId: string;
  /** Legacy item type string passed to ReactionPicker / CommentThread */
  reactionItemType: 'trip' | 'activity';
  entityId: string;
  reactions: Reaction[];
  comments: Comment[];
  ...
  onUnreact?: () => void;
  /** Pre-built shareData object (null when no trip/activity context) */
  shareData: ShareData | null;
}

/**
 * Engagement summary row (reaction counts + comment count toggle),
 * engagement action bar (ReactionPicker, Comment, Share buttons),
 * CommentThread drawer, and ShareModal.
 */
