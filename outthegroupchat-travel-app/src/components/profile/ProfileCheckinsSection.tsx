...
/**
 * ProfileCheckinsSection
 *
 * Renders the "Recent Check-ins" list on the user profile page.
 * Each check-in links to its detail page and shows an "Active" badge
 * while the check-in's activeUntil window is still open.
 */
