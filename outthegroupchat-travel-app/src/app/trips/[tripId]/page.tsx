        ...
        <div className="max-w-7xl mx-auto px-4 -mt-6 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
            {[
              ...
              { label: 'Members', icon: '👥', href: `/trips/${tripId}/members`, description: `${memberCount} member${memberCount !== 1 ? 's' : ''}` },
              { label: 'Invite', icon: '✉️', onClick: handleInvite, description: 'Add members' },
