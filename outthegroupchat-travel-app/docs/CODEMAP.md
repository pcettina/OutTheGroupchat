...
> Auto-generated 2026-03-10. Last updated 2026-04-09. Comprehensive reference for agents and developers.
...
**Total: ~1415 tests across 64 Vitest unit/integration test files** (0 TSC errors in production code, 0 in test files as of 2026-04-09)
...
| `src/__tests__/api/health.test.ts` | — | 9 | GET /api/health — DB connected, timestamp, public access, content-type, $queryRaw, 503 degraded, timeout, no raw error ✅ 2026-04-09 |
| `src/__tests__/api/trips-itinerary-recommendations.test.ts` | — | 17 | GET /api/trips/[tripId]/itinerary + GET /api/trips/[tripId]/recommendations ✅ 2026-04-09 |
| `src/__tests__/services/events.service.test.ts` | — | 42 | EventsService: searchEvents, searchPlaces, getPlaceDetails, searchFlights, getPriceEstimate, getDestinationInfo ✅ 2026-04-09 |
| `src/__tests__/lib/sanitize.test.ts` | — | 89 | sanitizeHTML, sanitizeInput, XSS vectors, edge cases ✅ 2026-04-09 |
| `src/__tests__/lib/pusher.test.ts` | — | 24 | Pusher auth, channel helpers, broadcast functions ✅ 2026-04-09 |
...
| Vitest tests | ~1415 passing (64 files) |
| E2E tests | 11 Playwright smoke tests (4 suites) |
| Error monitoring | Sentry installed (server + client + edge) — 16/48 routes instrumented; needs `SENTRY_DSN` in Vercel |
...
| `docs/UPGRADE_PLAN.md` | Dependency upgrade plan and migration notes ✅ 2026-04-09 |
