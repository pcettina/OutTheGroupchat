...
> Auto-generated 2026-03-10. Last updated 2026-04-06. Comprehensive reference for agents and developers.
...
**Stats:** ~266 TS/TSX files | ~34,000 LOC | 48 API routes | 92 components | 20 pages
...
**Total: ~1414 tests across 63 Vitest unit/integration test files** (0 TSC errors in production code, 0 in test files as of 2026-04-06)
...
| `src/__tests__/users-userid.test.ts` | — | 36 | GET/POST/PATCH /api/users/[userId] — public profile, follow/unfollow toggle, PATCH owner-only ✅ 2026-04-06 |
| `src/__tests__/activities-activityid.test.ts` | — | 36 | GET/POST/PUT /api/activities/[activityId] — activity detail, save/unsave, comment/rate ✅ 2026-04-06 |
| `src/__tests__/feed-engagement.test.ts` | — | 26 | GET/POST /api/feed/engagement — activity + trip stats, like/unlike, unauthenticated fallback ✅ 2026-04-06 |
...
| Vitest tests | ~1414 passing (63 files) |
