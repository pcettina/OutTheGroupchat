# Upgrade Plan — Trip Planning Archive

> **ARCHIVED 2026-04-17** — These upgrade notes were written for the trip-planning app stack. Many upgrades (Next.js 14→16, React 18→19, Prisma 5→7) still apply to the social pivot and should be tracked in the main UPGRADE_PLAN.md as the pivot stabilizes.
>
> Original file: docs/UPGRADE_PLAN.md (snapshot as of 2026-04-17)
