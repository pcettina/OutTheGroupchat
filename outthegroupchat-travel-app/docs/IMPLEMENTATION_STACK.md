...
| Technology | Version | Purpose |
|------------|---------|---------|
| **Next.js API Routes** | 14.1.3 | REST API (48 endpoints as of 2026-04-04) |
...
> As of 2026-04-04: 1341+ Vitest tests across 63 test files, 0 failures. Playwright spec exists; browsers need `npx playwright install chromium`.
...
### Core Models (Actual, as of 2026-04-04)
...
## API Endpoints (48 total as of 2026-04-04)
...
## File Structure (Actual, 2026-04-04)
...
|   |       +-- survey/page.tsx
|   |       +-- vote/page.tsx
|   |       +-- members/page.tsx  # Trip members management (added 2026-04-01)
|   +-- profile/
|   |   +-- [userId]/page.tsx     # Public user profile (added 2026-04-01)
|   +-- layout.tsx
|   +-- page.tsx
...
|   +-- setup.ts                  # Prisma mocks for all models
    (63 test files, 1341+ tests as of 2026-04-04)
...
npm run test         # Run Vitest test suite (1341+ tests)
...
4. **Rate Limiting**: Upstash Redis-based rate limiting on nearly all API routes (expanded 2026-04-04: invitations, profile, users, pusher, notifications, feed sub-routes, activities, survey, voting, members)
...
## Code Quality Metrics (2026-04-04)
